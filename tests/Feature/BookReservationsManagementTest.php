...
class BookReservationsManagementTest extends TestCase
{
    use RefreshDatabase;
    /** @test */
    public function a_book_can_be_checked_out()
    {
        ...
        $this->post('/reservations/'.$book->id.'/checkout',
        [
            'user_id'=>$user->id,
            'checked_out_at'=>'5/22/2019'
        ]);
    ...
    /** @test */
    public function checked_in_but_did_not_check_out_exception()
    {
